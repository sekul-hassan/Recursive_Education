...
function Refund(props) {
    return (
        <Container fluid="true" className="mt-4 mx-1 px-2">
            <h4 className="title text-dark">Refund Policy</h4>
            ...
            <h4 className="globalTitle">Eligibility for Refunds</h4>
            <p className="globalDescription">
                Refunds are available under the following conditions:
            </p>
            <h4 className="globalTitle">1. Courses and Subscriptions</h4>
            <ul>
            ...
            <h4 className="globalTitle">2. Workshops and Live Events</h4>
            <ul>
                <li className="globalDescription">
            ...
            <h4 className="globalTitle">Non-Refundable Items</h4>
            <p className="globalDescription">
            ...
            <h4 className="globalTitle">How to Request a Refund</h4>
            ...
            <h4 className="globalTitle">Refund Process</h4>
            <p className="globalDescription">
            ...
            <h4 className="globalTitle">Changes to the Refund Policy</h4>
            <p className="globalDescription">
